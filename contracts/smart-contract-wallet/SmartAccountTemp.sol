    ...
    ISignatureValidator
{
    ...
    //immutable regular implementation
    address private immutable _regularImplementation;
     ...
     */
    constructor(IEntryPoint anEntryPoint, address regularImplementation_) {
        _self = address(this);
        ...
        _regularImplementation = regularImplementation_;
    }
    ...
    function regularImplementation() public view returns (address) {
        return _regularImplementation;
    }
