...
async function main() {
    try {
        ...
        const DEPLOYMENT_FEE = BigNumber.from((deploymentGasPrice * deploymentGasLimit).toString())
        ...
        if (code === "0x") {
            ...
            console.log(`Deployer deployed at ${factoryDeployed.address} on chain ${chainId}`);
        } else {
