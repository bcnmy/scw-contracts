...
type DeploymentSaltsType = {
  ...
  MOCK_SESSION_VALIDATION_MODULE: string;
  NATIVE_TRANSFER_SESSION_VALIDATION_MODULE: string;
};
...
export const DEPLOYMENT_SALTS_DEV: DeploymentSaltsType = {
  ...
  MOCK_SESSION_VALIDATION_MODULE:
    "DEVX_MOCK_SESSION_VALIDATION_MODULE_V1_05092023",
  SMART_CONTRACT_OWNERSHIP_REGISTRY_MODULE:
    "DEVX_SMART_CONTRACT_OWNERSHIP_REGISTRY_MODULE_V0_21082023",
  NATIVE_TRANSFER_SESSION_VALIDATION_MODULE:
    "DEVX_NATIVE_XFR_SESSION_VALIDATION_MODULE_NYC_V2",
};
