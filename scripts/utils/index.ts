...
export enum DEPLOYMENT_SALTS {
  ...
  DECODER = "DECODER_V2",
  ENTRY_POINT = "ENTRY_POINT_V2",
  GAS_ESTIMATOR = "GAS_ESTIMATOR_V2",
  MULTI_SEND = "MULTI_SEND_V2",
  MULTI_SEND_CALLONLY = "MULTI_SEND_CALLONLY_V2",
  WALLET_FACTORY = "WALLET_FACTORY_V2",
  WALLET_IMP = "WALLET_IMP_V2",
  SINGELTON_PAYMASTER = "SINGELTON_PAYMASTER_V3",
}
