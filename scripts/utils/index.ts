...
type DeploymentSaltsType = {
  ...
  CONTRACT_CALL_SESSION_VALIDATION_MODULE: string;
...
export const DEPLOYMENT_SALTS_DEV: DeploymentSaltsType = {
  ...
  CONTRACT_CALL_SESSION_VALIDATION_MODULE:
    "DEVX_CONTRACT_CALL_SESSION_VALIDATION_MODULE_V1_05092023",
...
export const DEPLOYMENT_SALTS_PROD: DeploymentSaltsType = {
  ...
  CONTRACT_CALL_SESSION_VALIDATION_MODULE:
    "PROD_CONTRACT_CALL_SESSION_VALIDATION_MODULE_V1_09122023",
  SMART_CONTRACT_OWNERSHIP_REGISTRY_MODULE:
