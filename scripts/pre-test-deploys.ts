...
async function main() {
  ...
  const entryPointAddress = "0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789";
   ...
   const smartAccount = await SmartAccount.deploy(entryPointAddress,  {maxFeePerGas: 3e9, maxPriorityFeePerGas: 2e9});
...
*/
  ...
  const ecdsaOwnershipRegistryModule = await EcdsaOwnershipRegistryModule.deploy();
  await ecdsaOwnershipRegistryModule.deployed();
  console.log("EcdsaOwnershipRegistryModule deployed at: ", ecdsaOwnershipRegistryModule.address); 
